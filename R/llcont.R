...
llcont.polr <- function(x, ...) {
  ...
  ## Bolt: optimized extracting fitted values for observed class via direct 2D matrix subsetting
  ## to replace costly N x K dense one-hot matrix creation and rowSums
